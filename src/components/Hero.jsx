...
import nerdwallet from "../images/logos/nerdwallet.svg";
import investopedia from "../images/logos/investopedia.svg";
    ...
    <div {...props}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="#631DC0" />
            <stop offset="1" stopColor="#631DC0" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
      <svg
...
function Chart({
  ...
  let [interactionEnabled, setInteractionEnabled] = useState(true);
    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-gradient`} x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#631DC0" />
          <stop offset="100%" stopColor="#631DC0" stopOpacity="0" />
        </linearGradient>
      </defs>
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: "#631DC0", animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
          pathWidth.set(
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            ...
            <div className="text-sm text-gray-900">AUD</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              <div>1D</div>
              <div>5D</div>
              <div className="font-semibold text-[#631DC0] opacity-70">1M</div>
              <div>6M</div>
              <div>1Y</div>
              <div>5Y</div>
            </div>
            ...
            <div className="mt-4 rounded-lg opacity-70 py-2 px-4 text-center text-sm font-semibold text-white">
              Trade
            </div>
      ...
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-black text-[58px] tracking-tight text-gray-900">
              Investing made better
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              Stocks are great for making bets, but they’re only part of the
              investing story. Wealthfront makes it easy to build long-term
              wealth with fully diversified portfolios that help you manage
              risk, maximize returns, and minimize taxes
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              {/* <AppStoreLink /> */}
              <Button href="#" className="font-semibold px-4 py-3 text-xl">
                Get Started
              </Button>
            </div>
          </div>
